...
class ApartmentInfo extends React.Component {
  ...
  getApartmentInfo = () => {
    axios
      .post("http://localhost:33456/api/customer/getDetailApartment", {
        id: this.state.idApartment,
      })
      .then((response) => {
  ...
  getType = (idLoaiNha) => {
    ...
    axios
      .post("http://localhost:33456/api/customer/getTypeApartment", {
        idType: idLoaiNha,
      })
      .then((response) => {
  ...
  getAddress = (idNha) => {
    axios
      .post("http://localhost:33456/api/customer/getAddressApartment", {
        id: idNha,
      })
      .then((response) => {
